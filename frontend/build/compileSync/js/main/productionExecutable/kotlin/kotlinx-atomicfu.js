(function (factory) {
  ...
  protoOf(AtomicRef).xa = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).ya = function () {
  ...
  protoOf(AtomicBoolean).za = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).ya = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).ab = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).ya = function () {
    return this.kotlinx$atomicfu$value;
  };
